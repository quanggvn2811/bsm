        ...
        <div class="row col">
            ...
            <div class="row col-md-6 search-box-item">
                <div class="form-group row">
                    <label class="col-md-4" for="title">Name</label>
                    <div class="col-md-8">
                ...
                <div class="form-group row">
                    <label class="col-md-4" for="title">Phone</label>
                    <div class="col-md-8">
            ...
            <div class="row col-md-6 search-box-item">
                <div class="form-group row">
                    <label class="col-md-4" for="title">Order Number</label>
                    <div class="col-md-8">
                ...
                <div class="form-group row">
                    <div class="col-md-6" style="padding: 0">
                        <label class="col-md-4" for="title">Priority</label>
                        <div class="col-md-8">
